...
class MyAutoML:
    def __init__(self, cv=5,
        ...
        self.store_training_times = []
        self.store_pipeline_sizes = []
        self.store_inference_times = []
