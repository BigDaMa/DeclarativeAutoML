...
from fastsklearnfeature.declarative_automl.optuna_package.myautoml.cbays.ax_version.MyConstrainedAutoMLSpace import MyConstrainedAutoMLSpace
...
class SpaceGenerator:
    def __init__(self):
        ...
        self.space = MyConstrainedAutoMLSpace()
    ...
    def generate_params(self):
        ...
        self.space.generate_number('custom_weight', 0.5, depending_node=custom_weighting_p[0], low=0.00000001, high=1.0)

        category_aug = self.space.generate_cat('augmentation', self.augmentation_list, self.augmentation_list[0],
                                               depending_node=class_weighting_p[1])
