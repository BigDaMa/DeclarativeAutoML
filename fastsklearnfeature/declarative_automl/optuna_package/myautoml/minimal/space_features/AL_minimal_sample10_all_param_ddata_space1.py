...
from fastsklearnfeature.declarative_automl.optuna_package.myautoml.utils_model import space2features_v2
...
feature_names, feature_names_new = get_feature_names2(my_list_constraints)
...
def sample_configuration(trial):
    try:
        ...
        features = space2features_v2(space, my_list_constraints_values, metafeature_values)
