...
from fastsklearnfeature.declarative_automl.optuna_package.myautoml.utils_model_mine import generate_parameters_minimal_sample_constraints_all_uniform_datasets_eval_bool
...
def run_AutoML(trial):
    ...
    if trial.params['use_evaluation_time_constraint']:
