...
openml.config.cache_directory = '/home/felix/phd2/cache_openml'
...
#path2files = '/home/felix/phd2/decAutoML2weeks_compare2default/single_cpu_machine1_4D_start_and_class_imbalance'
path2files = '/home/felix/data/my_temp'
...
def sample_and_evaluate(my_id1):
    if time.time() - starting_time_tt > 60*60*24*2:
        return -1
...
with open('/home/felix/data/my_temp/my_great_model_compare_scaled.p', "wb") as pickle_model_file:
    pickle.dump(model_uncertainty, pickle_model_file)

with open('/home/felix/data/my_temp/felix_X_compare_scaled.p', "wb") as pickle_model_file:
    pickle.dump(dictionary['X_meta'], pickle_model_file)

with open('/home/felix/data/my_temp/felix_y_compare_scaled.p', "wb") as pickle_model_file:
    pickle.dump(dictionary['y_meta'], pickle_model_file)

with open('/home/felix/data/my_temp/felix_group_compare_scaled.p', "wb") as pickle_model_file:
    pickle.dump(dictionary['group_meta'], pickle_model_file)

with open('/home/felix/data/my_temp/felix_acquisition function value_scaled.p', "wb") as pickle_model_file:
