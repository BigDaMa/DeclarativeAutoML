...
def run_AutoML(trial):
    ...
    frequency = np.log(np.average(dynamic_values) / np.average(static_values))
...
class Objective(object):
    def __init__(self, model_uncertainty):
        ...
        with open('/home/neutatz/data/my_temp/dynamic_greater.p', "rb") as pickle_model_file:
            self.model_dynamic_greater_zero = pickle.load(pickle_model_file)
