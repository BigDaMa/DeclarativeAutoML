...
from fastsklearnfeature.declarative_automl.optuna_package.myautoml.smac_it.search_space import get_space_minimal
...
if __name__ == '__main__':
    ...
    #smac config space
    cs = get_space_minimal(total_search_time, my_openml_datasets)
