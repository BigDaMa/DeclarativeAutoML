...
for test_holdout_dataset_id in [args.dataset]:
    ...
    model_success_regression = pickle.load(open('/home/' + getpass.getuser() + '/data/my_temp/my_great_model_compare_scaled.p', "rb"))
    ...
    for minutes_to_search in [10, 30, 1*60, 5*60]:
        ...
        for repeat in range(10):
            ...
            if predictions[predictions_regression_best_id] > 0.25:
