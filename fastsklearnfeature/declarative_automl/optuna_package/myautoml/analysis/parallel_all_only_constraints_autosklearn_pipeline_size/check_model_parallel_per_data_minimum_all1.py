    ...
    for pipeline_size in [3175.0, 4026.22, 6651.52, 8359.48, 16797.0, 32266.96]:
        ...
        for repeat in range(10):
            ...
            try:
                ...
                pipeline_size, models, weights = utils.return_model_size(automl, y_train_hold, pipeline_size)

                result = 0
                try:
                    y_test_pred = utils.predict_with_models(automl, models, weights, X_test_hold)
