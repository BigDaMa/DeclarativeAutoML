...
try:
    ...
    for constraint_i in range(6):
        ...
        for datasetid in my_list:
            ...
            if type(None) != type(best_run_space):
                if constraint_i == 3:
                    all_features.append(best_run_space)
...
#/home/felix/phd2/dec_automl/jan29_features
dictionary = {}
dictionary['data'] = all_features
with open('/home/felix/phd2/dec_automl/jan29_features/fairness.p', "wb") as pickle_model_file:
    pickle.dump(all_features, pickle_model_file)