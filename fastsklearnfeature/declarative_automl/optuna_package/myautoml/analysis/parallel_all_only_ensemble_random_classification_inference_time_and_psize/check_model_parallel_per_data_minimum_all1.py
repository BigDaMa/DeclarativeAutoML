...
for test_holdout_dataset_id in [args.dataset]:
    ...
    for inference_time_limit in [0.0007910609245300294, 0.0008180351257324219, 0.0010206394195556641,
                                 0.0014590854644775393, 0.00301915740966]:

        for pipeline_size_limit in [4026.22, 6651.52, 8359.48, 16797.0, 32266.96]:
            ...
            new_constraint_evaluation_dynamic = ConstraintEvaluation(dataset=test_holdout_dataset_id,
                                                                     constraint={
                                                                         'inference_time_limit': inference_time_limit, 'pipeline_size_limit': pipeline_size_limit},
                                                                     system_def='dynamic')
