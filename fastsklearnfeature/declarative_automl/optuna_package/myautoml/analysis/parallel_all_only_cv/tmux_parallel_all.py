...
program = '/home/neutatz/Software/DeclarativeAutoML/fastsklearnfeature/declarative_automl/optuna_package/myautoml/analysis/parallel_all_only_cv/check_model_parallel_per_data_minimum_all1.py'
outputname = 'sample_instances_new2_all_cv'
