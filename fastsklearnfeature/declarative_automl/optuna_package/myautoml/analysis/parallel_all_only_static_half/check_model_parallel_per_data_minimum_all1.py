from fastsklearnfeature.declarative_automl.optuna_package.myautoml.my_system.successive_halving.MyAutoMLProcessClassBalanceDictHalve import MyAutoML
import optuna
...
for test_holdout_dataset_id in [args.dataset]:
    ...
    for minutes_to_search in [1, 5, 10, 60]:#[1, 5, 10, 60]:#range(1, 6):
