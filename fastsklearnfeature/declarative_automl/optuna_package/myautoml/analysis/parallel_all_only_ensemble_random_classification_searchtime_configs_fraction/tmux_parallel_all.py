...
program = '/home/' + getpass.getuser() + '/Software/DeclarativeAutoML/fastsklearnfeature/declarative_automl/optuna_package/myautoml/analysis/parallel_all_only_ensemble_random_classification_searchtime_configs_fraction/check_model_parallel_per_data_minimum_all1.py'
outputname = 'random_configs_fraction'
