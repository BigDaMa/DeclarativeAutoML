...
program = '/home/neutatz/Software/DeclarativeAutoML/fastsklearnfeature/declarative_automl/optuna_package/myautoml/analysis/run5/check_model_parallel_per_data_minimum_all1.py'
outputname = 'run5_'
