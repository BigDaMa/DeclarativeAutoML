...
def generate_parameters_minimal_sample_constraints(trial, total_search_time_minutes, my_openml_datasets, sample_data=True,
    ...
    return search_time, evaluation_time, memory_limit, privacy_limit, training_time_limit, inference_time_limit, pipeline_size_limit, cv, number_of_cvs, hold_out_fraction, sample_fraction, dataset_id, fairness_limit, use_ensemble, use_incremental_data
